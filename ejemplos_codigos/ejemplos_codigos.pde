...
*/
lerpColor(c1, c2, 0.5);
rect(480,295 + cos(p + 1.5)*50, 50,150, 25, 25, 25, 25 );
rect(440,280 + cos(p + 0.5)*50, 50,150, 25, 25, 25, 25 );
rect(400,300 + cos(p)*50, 50,150, 25, 25, 25, 25 );
rect(460,320 + cos(p + 1)*50, 50,150, 25, 25, 25, 25 );
rect(390,320+ sin(p + 0.5)*50, 50,150, 25, 25, 25, 25 );
